...
function Profile2() {
  ...
  return (
    ...
    <div className='w-full h-full m-0 p-0  bg-[#1E40A8] z-10 flex'>
        ...
        <div className='flex flex-col mx-auto pt-[8rem] h-[100vh] w-5/6 md:w-[60vw] z-10'>
            ...
            <div className=' w-full lg:h-full md:h-5/6 h-3/5 bg-[#1E40A8] border-black lg:border-[3px] border-t-[3px] lg:rounded-b-[80px] lg:rounded-t-xl mb-7'>
